  ...
  <div class="dict-container">
    ...
    <div class="page-header">
      <div class="header-content">
        <div class="header-icon">
          <i class="el-icon-notebook-2 icon-lg"></i>
        </div>
        <div class="header-text">
          <h1>字典管理</h1>
          <p>管理系统字典信息，包括添加、编辑、删除和查询</p>
        </div>
    ...
    <div class="table-section">
      <div class="table-header">
        <h3>字典列表</h3>
        <span class="table-count">{{ tableData.length }} 个字典</span>
      </div>
      <el-table 
        :data="tableData" 
        border 
      ...
      >
        ...
        <el-table-column prop="name" label="字典名称" min-width="150"></el-table-column>
        <el-table-column prop="value" label="字典编码" min-width="150"></el-table-column>
    ...
    >
      <el-form :model="form" :rules="rules" ref="dictForm">
        ...
        <el-form-item label="字典值" :label-width="formLabelWidth" prop="value">
          <el-input v-model="form.value" autocomplete="off" placeholder="请输入字典值"></el-input>
        </el-form-item>
